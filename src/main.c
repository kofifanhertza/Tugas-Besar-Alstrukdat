...
void Logo(){
    ...
    printf("||    |  \/  |         | |     (_) | |                                              / ____|                                ||\n");
    printf("||    | \  / |   ___   | |__    _  | |_    __ _   _ __     __ _    __ _    __ _    | |  __    __ _   _ __ ___     ___      ||\n");
    printf("||    | |\/| |  / _ \  | '_ \  | | | __|  / _` | | '_ \   / _` |  / _` |  / _` |   | | |_ |  / _` | | '_ ` _ \   / _ \     ||\n");
    printf("||    | |  | | | (_) | | |_) | | | | |_  | (_| | | | | | | (_| | | (_| | | (_| |   | |__| | | (_| | | | | | | | |  __/     ||\n");
    printf("||    |_|  |_|  \___/  |_.__/  |_|  \__|  \__,_| |_| |_|  \__, |  \__, |  \__,_|    \_____|  \__,_| |_| |_| |_|  \___|     ||\n");
    printf("||                                                         __/ |   __/ |                                                   ||\n");
    printf("||                                                        |___/   |___/                                                    ||\n");
